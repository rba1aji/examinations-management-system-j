...
import server.rba1aji.academicmanagementsystem.users.management.services.IStudentService;
...
//        student.setDateofbirth(null);
  ...
  @GetMapping("{id}/yearOfStudy")
  public ResponseEntity<Map<String, Integer>> getYearOfStudy(@PathVariable Long id) throws Exception {
    var res = new HashMap<String, Integer>();
    res.put("yearOfStudy", studentService.getYearOfStudy(id));
    return new ResponseEntity<>(res, HttpStatus.OK);
  }
}
