...
import server.rba1aji.academicmanagementsystem.users.management.sqlqueries.StudentSQL;
...
public class StudentRepo implements IStudentRepo {
    ...
    public Long create(Student student) throws AuthException {
        try {
            ...
            jdbcTemplate.update(con -> {
                PreparedStatement ps = con.prepareStatement(StudentSQL.SQL_STUDENT_CREATE, Statement.RETURN_GENERATED_KEYS);
    ...
    public Student findById(Long id) throws Exception {
        return jdbcTemplate.queryForObject(StudentSQL.SQL_STUDENT_FIND_BY_ID, new Object[]{id}, studentRowMapper);
    }

    @Override
    public Student findByIdDob(Long id, String dateofbirth) {
        return jdbcTemplate.queryForObject(StudentSQL.SQL_STUDENT_FIND_BY_ID_DOB, new Object[]{id, dateofbirth}, studentRowMapper);
    }

    @Override
    public List<Student> findAll() {
        return jdbcTemplate.query(StudentSQL.SQL_STUDENT_FIND_ALL, studentRowMapper);
    }

    @Override
    public List<Student> findByBranch(String branchid) {
        return jdbcTemplate.query(StudentSQL.SQL_STUDENT_FIND_BY_BRANCH, new Object[]{branchid}, studentRowMapper);
    }

    @Override
    public void update(Long id, Student st) {
        jdbcTemplate.update(StudentSQL.SQL_STUDENT_UPDATE,
                new Object[]{
    ...
    public List<Student> findByStartEndId(Long startid, Long endid) {
        return jdbcTemplate.query(StudentSQL.SQL_STUDENT_FIND_BY_START_END_ID, new Object[]{startid, endid}, studentRowMapper);
    }
